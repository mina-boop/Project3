      ...
      <div className="container-form">
        <form className="field" forHTML="meme" onSubmit={this.handleCreate}>
          ...
          <div className="control">
            <label className="label" htmlFor="caption1">
              Caption 1 :{" "}
            </label>
            <input
              className="input"
          ...
          <div className="control">
            <label className="label" htmlFor="caption2">
              Caption 2 :{" "}
            </label>
            <input
              className="input"
          ...
          {this.state.memeimage && (
            <div className="control">
              <input
                ...
                id="caption1"
                className="input"
                placeholder={this.state.caption1}
              />
              <img className="image" src={this.state.memeimage} alt="" />
              <input
                type="text"
                id="caption2"
                className="input"
                placeholder={this.state.caption2}
              />
            </div>
          )}
